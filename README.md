...
DreamDEX Event Contracts 提供 Up/Down 结果份额，让参与者对固定时间窗口内的市场方向做出判断。目前这类产品主要被当作信息和投机工具：用户下注、等待结算，然后兑现结果。

但事件合约本身可以被组合成更基础的原语。COMMON GROUND 的研究起点是：如果参与者交付的 Up 和 Down 份额可以合并成确定性资产，那么“对未来方向判断不同的人”就不必先达成共识，也能共同资助一件确定值得做的公共任务。

## 解决的问题

COMMON GROUND 针对三个具体问题：

1. **不同立场的人难以共同出资。**  
   Alice 看涨，Bob 看跌，即使他们都愿意支持同一个开源项目，也可能因为对未来判断不同而无法形成资金共识。

2. **研究、维护和行动服务缺少交付责任。**  
   用户愿意为固定范围的检查或研究付费，但担心结果不利时，服务商删帖、改口、拒绝退款。

3. **市场结果没有变成现实世界行动。**  
   结算通常只是“赢了或输了”，没有自动触发下一步公共任务。

此外，COMMON GROUND 明确不做收益承诺，也不把市场方向当作某项公共服务是否值得存在的判断依据。公共价值由参与者事先认可。

## 如何解决

COMMON GROUND 把参与者交付的互补事件权益，转成有资金保障、有明确授权、有交付责任的共同任务。

1. **互补份额合并为基础预算。**  
   同一市场的 Up 和 Down 份额按计划配对并合并成确定性资产，用于在市场结算前启动基础任务。这部分资金不再依赖市场最终方向。

2. **把行动拆成“无条件”和“有条件”两阶段。**  
   基础任务在资金足额后即可启动；追加任务只在市场正式结算后，且方向、预算、交付和期限条件全部满足时才启动。

3. **用固定计划锁定授权和交付责任。**  
   Plan Manifest 固定市场、份额、金额、执行者、验收者、截止时间和退出规则。发布后不能随意改用途、改收款人或挪用资金。

4. **失败和作废有明确回收路径。**  
   未募满、交付失败、市场作废、追加方向失败等情况分别处理，原始份额或剩余资产按预先约定的规则退回贡献者。
